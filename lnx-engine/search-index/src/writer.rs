...
use crate::structures::{DocumentPayload, IndexContext, INDEX_STORAGE_SUB_PATH, ROOT_PATH};
...
impl Writer {
    ...
    pub(crate) async fn destroy(&self) -> anyhow::Result<()> {
        ...
        let dir = format!("{}/{}/{}", ROOT_PATH, INDEX_STORAGE_SUB_PATH, cr32_hash(&self.index_name));
