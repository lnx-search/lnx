...
static METASTORE_COMMIT_DATABASE: &str =
    "lnx_metastore__block_storage_commit_checkpoints";
...
impl BlockStorageMetastore {
    ...
    pub async fn set_file_commit_checkpoint_async(
        &self,
        file_key: FileKey,
        pos: u64,
    ) -> Result<()> {
    ...
    pub async fn get_file_commit_checkpoint_async(
        &self,
        file_key: FileKey,
    ) -> Result<Option<u64>> {
