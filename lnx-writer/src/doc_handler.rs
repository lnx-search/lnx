...
use lnx_storage::{engine, ChangeLogEntry, ChangeKind};
...
pub async fn add_documents(index_name: &str, documents: Vec<Document>) -> Result<(), DocumentError> {
