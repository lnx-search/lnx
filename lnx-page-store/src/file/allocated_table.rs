...
impl PageAllocationTable {
    ...
    pub fn to_bytes(&self) -> Vec<u8> {
        ...
        buffer.extend_from_slice(&(self.allocated_pages.data.len() as u32).to_le_bytes());        
    ...
    pub fn from_bytes(buffer: &[u8]) -> Option<Self> {
        ...
        for pos in 0..bitset_size {
            ...
            let sector = u64::from_le_bytes(buffer[bytes_start..bytes_end].try_into().unwrap());
